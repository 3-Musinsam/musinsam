...
@Builder
public record ResCouponUseDtoApiV3(
    UUID couponId,
    UUID couponPolicyId,
    Long userId,
    UUID orderId,
  ...
  public static ResCouponUseDtoApiV3 from(CouponEntity couponEntity, CouponPolicyEntity couponPolicyEntity) {
    return ResCouponUseDtoApiV3.builder()
