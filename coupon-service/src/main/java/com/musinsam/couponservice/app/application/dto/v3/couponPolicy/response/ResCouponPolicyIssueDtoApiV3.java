...
@Builder
public record ResCouponPolicyIssueDtoApiV3(
  ...
  public static ResCouponPolicyIssueDtoApiV3 from(CouponPolicyEntity couponPolicyEntity) {
    return ResCouponPolicyIssueDtoApiV3.builder()
