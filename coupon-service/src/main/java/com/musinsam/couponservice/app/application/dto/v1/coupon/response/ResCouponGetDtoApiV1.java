...
@NoArgsConstructor
@AllArgsConstructor
public class ResCouponGetDtoApiV1 {
  ...
  public static ResCouponGetDtoApiV1 from(CouponEntity savedCouponEntity, CouponPolicyEntity couponPolicyEntity) {
    return ResCouponGetDtoApiV1.builder()
